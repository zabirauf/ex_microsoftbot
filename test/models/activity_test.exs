  ...
  describe ".parse/1" do
    test "parses a map to the right types" do
      ...
      assert recipient == %ExMicrosoftBot.Models.ChannelAccount{
        id: "someother:id", name: "Some Other Name"
      }
      assert textFormat == "plain"
      assert attachmentLayout == "flat"
      assert membersAdded == [%ExMicrosoftBot.Models.ChannelAccount{
        id: "someother:id", name: "Some Other Name"
      }]
      assert membersRemoved == [%ExMicrosoftBot.Models.ChannelAccount{
      ...
      assert attachments == [%ExMicrosoftBot.Models.Attachment{
        contentType: "image/png",
        contentUrl: "https://some.site/image.png",
        name: "A great picture",
        thumbnailUrl: "https://some.site/image-tiny.png",
      }]
      assert entities == [%ExMicrosoftBot.Models.Entity{
        type: "type",
        name: "name",
        supportsDisplay: false
      }]
